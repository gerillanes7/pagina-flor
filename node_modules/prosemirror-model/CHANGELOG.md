...
Perform attribute validation in `NodeType`/`MarkType.create` to make it easier to ensure it happens for every way nodes and marks are created.

## 1.25.11 (2026-07-11)

### Bug fixes

Fix parsing of trailing/leading whitespace when the element given to parseSlice is a body element.
