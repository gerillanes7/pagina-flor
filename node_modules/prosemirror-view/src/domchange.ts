...
function parseBetween(view: EditorView, from_: number, to_: number, addedNodes: readonly DOMNode[]) {
...
const ruleFromNode = (added: readonly DOMNode[]) => (dom: DOMNode): Omit<TagParseRule, "tag"> | null => {
...
function looksLikeEnter(content: Node, from: number, to: number) {
